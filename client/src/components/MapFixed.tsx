...
// Define window.google type for TypeScript
declare global {
  interface Window {
    google: any;
  }
...
export default function MapFixed({ center, issues, heatmapActive, onMarkerClick }: MapProps) {
  ...
  useEffect(() => {
    if (window.google) {
      // Google Maps is already loaded, initialize map
      initializeMap();
      return;
    }
