      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <section className="mb-6">
          ...
          >
            ...
            <div className="p-4 flex justify-center items-center">
              <div className="bg-gray-100 rounded w-full h-20 flex items-center justify-center hover:bg-gray-200 transition-colors">
        ...
        <section className="mb-6">
          ...
          >
            ...
            <div className="p-4 flex justify-center items-center">
              <div className="bg-gray-100 rounded w-full h-32 flex items-center justify-center hover:bg-gray-200 transition-colors">
                <p className="text-sm text-gray-600 font-medium">Advertise here</p>
              </div>
            </div>
          </div>
